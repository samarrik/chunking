# This script is adapted from the https://github.com/brandonstarxel/chunking_evaluation which is in turn adapted from LangChain package, developed by LangChain AI.
